...
my $htmltext = Text::MediawikiFormat::format( $wikitext, {}, { extended => 1, absolute_links => 1 } );
...
$htmltext = Text::MediawikiFormat::format( $wikitext, {}, { extended => 1, absolute_links => 0 } );
is( $htmltext,
...
$htmltext = Text::MediawikiFormat::format( $wikitext, {}, { extended => 1, absolute_links => 1 } );
is( $htmltext,
     qq|<p>this is a moose:notalink</p>\n|,
     q|Doesn't pick up things that might look like links|
   );

$htmltext = Text::MediawikiFormat::format( $wikitext, {schemas => ['moose']}, { extended => 1, absolute_links => 1 } );
is( $htmltext,
