...
$htmltext = Text::MediawikiFormat::format($wikitext, { blocks => { code => '\t' }} );
...
my @processed = Text::MediawikiFormat::nest_blocks( [] );
is( @processed, 0, 'nest_blocks() should not autovivify empty blocks array' );
